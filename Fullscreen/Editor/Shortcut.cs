...
namespace FullscreenEditor {
    ...
    internal class Shortcut {
        ...
        [DynamicMenuItem(true)] public const string TOOLBAR_PATH = "Tools/Fullscreen/Show Toolbar _F8";
        [DynamicMenuItem(true)] public const string FULLSCREEN_ON_PLAY_PATH = "Tools/Fullscreen/Fullscreen On Play ";
        [DynamicMenuItem(true)] public const string PREFERENCES_PATH = "Tools/Fullscreen/Preferences... ";
        [DynamicMenuItem(false)] public const string CURRENT_VIEW_PATH = "Tools/Fullscreen/Focused View _F9";
        [DynamicMenuItem(false)] public const string GAME_VIEW_PATH = "Tools/Fullscreen/Game View _F10";
        [DynamicMenuItem(false)] public const string SCENE_VIEW_PATH = "Tools/Fullscreen/Scene View _F11";
        [DynamicMenuItem(false)] public const string MAIN_VIEW_PATH = "Tools/Fullscreen/Main View _F12";
        [DynamicMenuItem(false)] public const string MOSAIC_PATH = "Tools/Fullscreen/Mosaic %F10";
        [DynamicMenuItem(true)] public const string CLOSE_ALL_FULLSCREEN = "Tools/Fullscreen/Close All %F12";
