    ...
    public class FullscreenWindow : FullscreenContainer {
        ...
        public override void Focus() {
            try {
                ...
                Logger.Error($"Error focusing window: {ex.Message}");
                base.Focus();
            }
        }
        ...
        public override bool IsFocused() {
            try {
                ...
                var pyramidWindow = ActualViewPyramid.Window;
                if (pyramidWindow == null)
                    return false;
            
                return focusedWindow == pyramidWindow;
            }
            catch (Exception ex) {
                Logger.Error($"Error checking focus state: {ex.Message}");
                return false;
            }
        }
