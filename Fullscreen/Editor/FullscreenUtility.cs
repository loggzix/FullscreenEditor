...
namespace FullscreenEditor {
    ...
    public static class FullscreenUtility {
        ...
        private static ScriptableObject cachedMainView;
        private static readonly object mainViewLock = new object();

        /// <summary>Get the main view with caching for better performance.</summary>
        public static ScriptableObject GetMainView() {
            if (cachedMainView != null)
                return cachedMainView;
            ...
            lock (mainViewLock) {
                ...
                if (containers == null || containers.Length == 0)
                    throw new InvalidOperationException("Couldn't find main view");

                cachedMainView = containers[0] as ScriptableObject;
                return cachedMainView;
            }
        }

        /// <summary>Clear the cached main view when needed.</summary>
        public static void ClearMainViewCache() {
            lock (mainViewLock) {
                cachedMainView = null;
            }
        }
